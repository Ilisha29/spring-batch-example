...
public class ItemWriterConfiguration {
    ...
    private ItemWriter<Person> csvFileItemWriter() throws Exception {
        BeanWrapperFieldExtractor<Person> filedExtractor = new BeanWrapperFieldExtractor<>();
        filedExtractor.setNames(new String[]{"id", "name", "age", "address"});
    ...
    private List<Person> getItems() {
        ...
        for (int i = 0; i < 100; i++) {
            items.add(new Person("test name " + i, "test age" + i, "test address"));
        }
        return items;
    }
}
