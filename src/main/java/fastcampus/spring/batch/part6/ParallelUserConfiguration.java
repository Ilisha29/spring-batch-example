...
public class ParallelUserConfiguration {
    ...
    public Flow saveUserFlow() {
        TaskletStep saveUserStep = this.stepBuilderFactory.get(JOB_NAME + "_saveUserStep")
                ...
                .build();
        return new FlowBuilder<SimpleFlow>(JOB_NAME + "_saveUserStep")
                .start(saveUserStep)
                .build();
    }
    ...
    private ItemWriter<? super OrderStatistics> orderStatisticsItemWriter(String date) throws Exception {
        ...
        BeanWrapperFieldExtractor<OrderStatistics> filedExtractor = new BeanWrapperFieldExtractor<>();
        filedExtractor.setNames(new String[]{"amount", "date"});
        ...
        FlatFileItemWriter<OrderStatistics> itemWriter = new FlatFileItemWriterBuilder<OrderStatistics>()
                ...
                .encoding("UTF-8")
                .headerCallback(writer -> writer.write("total_amout, date"))
                .build();
